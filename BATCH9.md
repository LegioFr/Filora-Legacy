...
- règle de sortie : si la prochaine revue trouve encore un **nouveau** contournement réaliste de la chaîne de preuve, arrêter les rustines chemin par chemin et reconsidérer l’architecture du contrôle avant toute nouvelle extension.
