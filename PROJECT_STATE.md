...
- Finding de processus constaté après la promotion Batch 1 : la validation humaine de l’application n’avait pas été réalisée avant la déclaration de clôture. Traitement en cours par règle canonique dédiée ; Batch 1 reste non clôturable jusqu’à validation humaine.
...
1. Intégrer la règle canonique de validation humaine sans prétendre que son futur garde-fou mécanique la valide lui-même.
2. Rendre le socle Batch 1 accessible/testable par Mickaël et effectuer la validation humaine applicative manquante.
3. Corriger tout défaut observé avant de reclôturer Batch 1.
4. Après reclôture réelle seulement, reprendre l’Issue #21 dans son périmètre dédié.
